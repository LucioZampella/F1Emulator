...
class DriversPaceComparator:
    ...
    def compare(self, laps_d1: Laps, laps_d2: Laps) -> tuple[float, float] | None:

        laps_d1 = self.lap_filter.adjust_fuel_consumption(laps_d1)
        laps_d2 = self.lap_filter.adjust_fuel_consumption(laps_d2)
