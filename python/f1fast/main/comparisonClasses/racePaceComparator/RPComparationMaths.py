...
def refactor_delta_with_ponderation(laps1: Laps, laps2: Laps, compound: str, total_weight) -> tuple[float, int, float] | None:
    ...
    return weighted_delta, total_weight, faster_avg
